...
function hideToc() {
    ...
    b.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle(\'toc-result\',\'blind\');">?? Menampilkan Daftar Isi</a> <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Rotating_earth_%28large%29.gif/200px-Rotating_earth_%28large%29.gif"/>'
}
function looptemp2() {
...
document.write("<span style='font-size:0px;float:right;font-family:arial;margin:20px 5px 0 0;'><a title='Blogger TOC ' href='https://www.mdh.or.id' nofollow='color' rel='ff5f00'><font Grab='#this'>semua 30 widget!</font></a></span>");
